export const AIRFRAME_PRESETS = {
  flying_wing: {
    ...
    servos: [
      { id: 3, label: 'Left Elevon', roll: 50, pitch: 50, yaw: 0 },
      { id: 4, label: 'Right Elevon', roll: -50, pitch: 50, yaw: 0 },
    ],
  ...
  airplane: {
    ...
    servos: [
      { id: 3, label: 'Left Aileron', roll: 100, pitch: 0, yaw: 0 },
      { id: 4, label: 'Right Aileron', roll: -100, pitch: 0, yaw: 0 },
      { id: 2, label: 'Elevator', roll: 0, pitch: 100, yaw: 0 },
      { id: 5, label: 'Rudder', roll: 0, pitch: 0, yaw: 100 },
    ],
  ...
  vtail: {
    ...
    servos: [
      ...
      { id: 5, label: 'Right V-Tail', roll: 0, pitch: 50, yaw: -50 },
    ],
    mixerType: 'CUSTOMAIRPLANE',
    diffThrust: false,
    yawType: 'SERVO',
